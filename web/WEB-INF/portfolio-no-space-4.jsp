<%-- 
    Document   : portfolio-no-space-4
    Created on : Nov 2, 2020, 1:28:02 PM
    Author     : my laptop
--%>
      ...
      <div id="heading-breadcrumbs">
        <div class="container">
          <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
              <h1 class="h2">Portfolio - no space + 4 columns</h1>
            </div>
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                <li class="breadcrumb-item active">Portfolio - no space + 4 columns</li>
              </ul>
            </div>
          </div>
        </div>
