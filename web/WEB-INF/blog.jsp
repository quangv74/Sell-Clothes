<%-- 
    Document   : blog
    Created on : Nov 2, 2020, 1:10:17 PM
    Author     : my laptop
--%>
      ...
      <div id="heading-breadcrumbs">
        <div class="container">
          <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
              <h1 class="h2">Blog Listing: Big</h1>
            </div>
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                <li class="breadcrumb-item active">Blog Listing: Big</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div class="row bar">
            ...
            <div id="blog-listing-big" class="col-md-9">
              <section class="post">
                ...
                <div class="image"><a href="blog-post.html"><img src="img/blog2.jpg" alt="Example blog post alt" class="img-fluid"></a></div>
