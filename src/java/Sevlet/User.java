...
//        ArrayList<AccountUser> a = ac.getListUser();
//        for (AccountUser accountUser : a) {
//            if(accountUser.getUsername().trim().equals(user) && accountUser.getPassword().trim().equals(password)){
//                response.getWriter().print("oke");
//                break;
//            }            
//        }
        boolean b = ac.checkUser(user, password);
        if(b){
