<%-- 
    Document   : template-content-boxes
    Created on : Nov 2, 2020, 1:39:31 PM
    Author     : my laptop
--%>
      ...
      <div id="heading-breadcrumbs">
        <div class="container">
          <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
              <h1 class="h2">Horizontal Blocks</h1>
            </div>
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                <li class="breadcrumb-item active">Horizontal Blocks</li>
              </ul>
            </div>
          </div>
        </div>
                  ...
                  <div class="box-image">
                    <div class="image"><img src="img/portfolio-1.jpg" alt="" class="img-fluid">
                      <div class="overlay d-flex align-items-center justify-content-center">
                        <div class="content">
                          <div class="name">
                            <h3><a href="portfolio-detail.html" class="color-white">Portfolio box-image</a></h3>
                          </div>
                          <div class="text">
              ...
              <div class="row d-flex align-items-stretch same-height">
                ...
                <div class="col-md-4">
                  <div class="box-simple box-white same-height">
                    ...
                    <h4>Print</h4>
                    <p>Advantage old had otherwise sincerity dependent additions. It in adapted natural hastily is justice. Six draw you him full not mean evil. Prepare garrets it expense windows shewing do.</p>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="box-simple box-white same-height">
