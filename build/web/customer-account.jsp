                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="firstname" type="text" class="form-control" name="firstname1">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="lastname">Lastname</label>
                                                <input id="lastname" type="text" class="form-control" name="lastname1">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="company" type="text" class="form-control" name="company1">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="street">Street</label>
                                                <input id="street" type="text" class="form-control" name="street1">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input id="zip" type="text" class="form-control" name="gender1">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="phone" type="text" class="form-control" name="phone1">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="email_account">Email</label>
                                                <input id="email_account" type="text" class="form-control" name="email1">
                                            </div>
                                        </div>
