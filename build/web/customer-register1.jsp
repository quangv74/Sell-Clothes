                            ...
                            <div class="box">
                                ...
                                <form action="User" method="POST">
                                    <div class="form-group">
                                        ...
                                        <input id="email" type="text" class="form-control" value="${sessionScope.account.username}" name="user">
                                    </div>
                                    <div class="form-group">
                                        <label for="password">Password</label>
                                        <input id="password" type="password" class="form-control" value="${sessionScope.account.password}" name="password">
                                    </div       >
                                    <div class="text-center">
